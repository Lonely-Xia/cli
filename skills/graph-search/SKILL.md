...
Use this skill when the user selects `Graph Search` in a supported AI tool or provides a natural-language
query after `graph search`. Everything after the invocation is the query; do not require the user to know
CLI flags.
